...
public:
	...
	//线性拉伸
	void LinearStrech(CPoint point1, CPoint point2, unsigned char *m_pImgData ,int BandCount, int m_imgWidth, int m_imgHeight);
	//单通道数据线性拉伸
	void LinearStrechForSnglChannel(unsigned char *pImgDataIn, unsigned char *pImgDataOut,int imgWidth,int imgHeight, CPoint point1,CPoint point2);
